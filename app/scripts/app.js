...
var playerView = Backbone.View.extend({
    ...
    render: function () {
        this.$el.html(this.template(this.model.attrbutes));
...
console.log('confPlayer : ', confPlayer);
console.log('player : ', player);


    //$scope.track = {name: 'lalala',artist: {name: 'toto'},album: {name: 'tralala'}};
    //var audioPlayer = document.getElementById('audioplayer'),audioTrack = document.getElementById('audiotrack'),playButton = angular.element('[data-ctrl="play"]'),fader = document.getElementById('fader'),playback = document.getElementById('playback'),playbackTime = document.getElementById('playbacktime'),playhead = document.getElementById('playhead'),volumeSlider = document.getElementById('volumeSlider'),duration = audioTrack.duration,isMute = false,restorValue,_setText = function (el, text) {el.text(text);};
